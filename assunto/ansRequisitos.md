...
A pequena locadora da Ana Luiza tem filmes com gêneros distintos, cada cliente pode locar seus filmes mediante o pagamento de R$4,50 para a categoria lançamento ou R$ 3,00 para a categoria catálogo. Ana luiza pretende ter outras faixas de preços para categorias que serão definidas. Para fazer a locação o cliente precisa preencher um formulário com *nome*, *endereço*, *telefone*, *email*, *rg* e *cpf*. A locação fica registrada na locadora que entraga uma cópia desse registro para o cliente com a *data da locação* e a *data da devolução*, apenas para controle do cliente. Os filmes tem destaque para caracerísticas como *nome*, *duração*, *sinopse*, *foto*, *estado da locação* e *quantidade de filmes disponíveis*, para indicar se existe alguma cópia do filme disponível.
