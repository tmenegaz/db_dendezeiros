...
Quanto ao grau de cardinalidade, um traço na vertical ( **|** ) em uma das extremidades irá indicar uma ocorrência e um tridente na ponta oposta indicará mais de uma ocorrência.

Dito isso, é importante esclarecer que existem *3* graus de cardinalidade.
...
A figura abaixo ilustra as possíveis cardinalidades

![cardinalidades](img/diagramaRelacionamento.png "Cardinalidades")